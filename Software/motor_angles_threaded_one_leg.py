...
result_row0=result_row0[:5]
result_row1=result_row1[:5]
print(result_row0)
print(result_row1)

angles_p = [5, 0, -5, 0, 5, 0, -5, 0]
angles_y = [0, 5, 0, -5, 0, 5, 0, -5]
...
def l1_thread():
  ...
  for i in range(len(result_row0)):
    ...
    cmd += str(0) + "$" + str(int(math.degrees(angles_y[i]))) + "$" + str(1) + "$" + str(int(math.degrees(angles_p[i])))
...
def main():
  ...
  ser1 = serial.Serial(ard3, 9600, timeout=1)
